...
struct App {
    ...
    pending_update: bool,
    last_command: String,  // Добавлено поле для последней выполненной команды
...
fn ui(frame: &mut Frame, app: &App) {
    let chunks = Layout::default()
        ...
        .constraints([Constraint::Length(5), Constraint::Min(1)].as_ref())  // Увеличили высоту верхней панели
        .split(frame.size());
